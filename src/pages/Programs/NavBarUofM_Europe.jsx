...
import "./NavBarUofM_Europe.css";

class NavbarPage_Europe extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            collapse: false,
    ...
    render() {
        const bgPink = {backgroundColor: '#7C3F00'}
        return(
            <div id="UofMNav_Europe">
                <header>
...
export default NavbarPage_Europe;