...
import UofMProgramFrance_Contact from './France_Sports_Contact';
...
class France_Page_Structure_Contact extends React.Component {
    render () {
        return (
...
export default France_Page_Structure_Contact;