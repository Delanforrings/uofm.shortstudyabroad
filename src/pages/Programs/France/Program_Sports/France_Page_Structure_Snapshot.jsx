...
import UofMProgramFrance_Sports from './France_Sports_Snapshot';
...
class France_Page_Structure extends React.Component {
    render () {
        return (
            <div id="France_Structure">
                <Helmet>
                    <title>Snapshot || Study Abroad in Montpellier, France || Learning Abroad Center</title>
                </Helmet>
...
export default France_Page_Structure;