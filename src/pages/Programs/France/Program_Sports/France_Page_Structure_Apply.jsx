...
import UofMProgramFrance_Sports_Apply from './France_Sports_Apply';
...
class France_Page_Structure_Apply extends React.Component {
    render () {
        return (
            <div id="France_Structure">
                <Helmet>
                    <title>Apply || Study Abroad in Montpellier, France || Learning Abroad Center</title>
                </Helmet>
                        ...
                        <div className="homeText">
                            <MDBRow around>
                                ...
                                <MDBCol size="6">
                                    <div className="homeText">
                                        <Animation type="fadeIn">
                                            <UofMProgramFrance_Sports_Apply/>
                                        </Animation>
                                    </div>
                                </MDBCol>
                            </MDBRow>
...
export default France_Page_Structure_Apply;