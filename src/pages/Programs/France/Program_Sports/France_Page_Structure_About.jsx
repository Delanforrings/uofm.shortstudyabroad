...
import UofMProgramFrance_Sports_About from './France_Sports_About';
...
class France_Page_Structure_About extends React.Component {
    render () {
        return (
            <div id="France_Structure">
                <Helmet>
                    <title>About || Study Abroad in Montpellier, France || Learning Abroad Center</title>
                </Helmet>
                            ...
                            <div className="homeText">
                                <MDBRow around>
                                    ...
                                    <MDBCol size="6">
                                        <div className="homeText">
                                            <Animation type="fadeIn">
                                                <UofMProgramFrance_Sports_About/>
                                            </Animation>
                                        </div>
                                    </MDBCol>
                                </MDBRow>
...
export default France_Page_Structure_About;