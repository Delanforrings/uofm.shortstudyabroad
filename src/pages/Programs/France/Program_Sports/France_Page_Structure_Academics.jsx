...
import UofMProgramFrance_Sports_Academics from './France_Sports_Academics';
...
class France_Page_Structure_Academics extends React.Component {
    render () {
        return (
            <div id="France_Structure">
                <Helmet>
                    <title>Academics|| Study Abroad in Montpellier, France || Learning Abroad Center</title>
                </Helmet>
                            ...
                            <div className="homeText">
                                <MDBRow around>
                                    ...
                                    <MDBCol size="6">
                                        <div className="homeText">
                                            <Animation type="fadeIn">
                                                <UofMProgramFrance_Sports_Academics/>
                                            </Animation>
                                        </div>
                                    </MDBCol>
                                </MDBRow>
...
export default France_Page_Structure_Academics;