...
import UofMProgramFrance_Contact_Alum from './France_Sports_Contact_Alum';
...
class France_Page_Structure_Contact_Alum extends React.Component {
    render () {
        return (
            <div id="France_Structure">
                <Helmet>
                    <title>Contact || Study Abroad in Montpellier, France || Learning Abroad Center</title>
                </Helmet>
                        ...
                        <div className="homeText">
                            <MDBRow around>
                                ...
                                <MDBCol size="6">
                                    <div className="homeText">
                                        <Animation type="fadeIn">
                                            <UofMProgramFrance_Contact_Alum/>
                                        </Animation>
                                    </div>
                                </MDBCol>
                            </MDBRow>
...
export default France_Page_Structure_Contact_Alum;