...
import UofMProgramFrance_Sports_Fees from './France_Sports_Fees';
...
class France_Page_Structure_Fees extends React.Component {
    render () {
        return (
            <div id="France_Structure">

                <Helmet>
                    <title>Fees || Study Abroad in Montpellier, France || Learning Abroad Center</title>
                </Helmet>
...
export default France_Page_Structure_Fees;