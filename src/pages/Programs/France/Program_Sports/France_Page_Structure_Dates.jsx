...
import UofMProgramFrance_Sports_Dates from './France_Sports_Dates';
...
class France_Page_Structure_Dates extends React.Component {
    render () {
        return (
            <div id="France_Structure">
                <Helmet>
                    <title>Dates || Study Abroad in Montpellier, France || Learning Abroad Center</title>
                </Helmet>
                       ...
                       <div className="homeText">
                           <MDBRow around>
                               ...
                               <MDBCol size="6">
                                   <div className="homeText">
                                       <Animation type="fadeIn">
                                           <UofMProgramFrance_Sports_Dates/>
                                       </Animation>
                                   </div>
                               </MDBCol>
                           </MDBRow>
...
export default France_Page_Structure_Dates;