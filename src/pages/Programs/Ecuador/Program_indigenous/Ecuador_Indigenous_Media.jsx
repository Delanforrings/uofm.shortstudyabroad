...
class Ecuador_Indigenous_Media extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <div id="programEcuador">
                <h1 className="colorChange">Indigenous Healing & Public Health in Ecuador — Media</h1>
                <BrowserView>
                    <div>
                        <Table>
                            <TableBody>
...
export default Ecuador_Indigenous_Media;