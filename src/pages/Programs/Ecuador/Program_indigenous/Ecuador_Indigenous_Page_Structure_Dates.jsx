...
import Ecuador_Indigeous_Dates from "./Ecuador_Indigeous_Dates";

class Ecuador_Indigenous_Page_Structure_Dates extends React.Component {
    render () {
        return (
...
export default Ecuador_Indigenous_Page_Structure_Dates;