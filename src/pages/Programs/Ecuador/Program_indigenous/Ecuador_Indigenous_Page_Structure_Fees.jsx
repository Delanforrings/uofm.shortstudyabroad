...
import Ecuador_Indigenous_Fees from "./Ecuador_Indigenous_Fees";

class Ecuador_Indigenous_Page_Structure_Fees extends React.Component {
    render () {
        return (
...
export default Ecuador_Indigenous_Page_Structure_Fees;