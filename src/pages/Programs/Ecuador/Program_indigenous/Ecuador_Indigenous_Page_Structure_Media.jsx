...
import UofMProgramFrance_Sports_Media from './Ecuador_Indigenous_Media';
import '../Ecuador_Page_Structure.css';
import Navbar from '../NavBarUofM_US';
import UofMFooter from '../../../UofMFooter';
import { Helmet } from 'react-helmet';
import {BrowserView, MobileView} from "react-device-detect";
import Ecuador_Indigenous_Media from './Ecuador_Indigenous_Media';


class Ecuador_Indigenous_Page_Structure_Media extends React.Component {
    render () {
        return (
            <div id="Ecuador_Structure">
                <Helmet>
                    <title>Media || Study Abroad in Quito, Ecuador || Learning Abroad Center</title>
                </Helmet>
...
export default Ecuador_Indigenous_Page_Structure_Media;