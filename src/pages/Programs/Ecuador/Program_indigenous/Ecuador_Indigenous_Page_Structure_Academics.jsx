...
import Ecuador_Indigenous_Academics from "./Ecuador_Indigenous_Academics";

class Ecuador_Indigenous_Page_Structure_Academics extends React.Component {
    render () {
        return (
...
export default Ecuador_Indigenous_Page_Structure_Academics;