...
class Ecuador_Indigenous_Page_Structure_Snapshot extends React.Component {
    render () {
        return (
...
export default Ecuador_Indigenous_Page_Structure_Snapshot;