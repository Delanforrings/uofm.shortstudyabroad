...
import Ecuador_Indigenous_Contact_Alum from "./Ecuador_Indigenous_Contact_Alum";

class Ecuador_Indigenous_Page_Structure_Contact_Alum extends React.Component {
    render () {
        return (
                        ...
                        <div className="homeText">
                            <MDBRow around>
                                ...
                                <MDBCol size="6">
                                    <div className="homeText">
                                        <Animation type="fadeIn">
                                            <Ecuador_Indigenous_Contact_Alum/>
                                        </Animation>
                                    </div>
                                </MDBCol>
                            </MDBRow>
...
export default Ecuador_Indigenous_Page_Structure_Contact_Alum;