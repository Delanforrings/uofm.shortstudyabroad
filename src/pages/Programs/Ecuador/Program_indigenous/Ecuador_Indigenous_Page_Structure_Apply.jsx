...
import Ecuador_Indigenous_Apply from "./Ecuador_Indigenous_Apply";

class Ecuador_Indigenous_Page_Structure_Apply extends React.Component {
    render () {
        return (
...
export default Ecuador_Indigenous_Page_Structure_Apply;