...
import Ecuador_Indigenous_About from "./Ecuador_Indigenous_About";

class Ecuador_Indigenous_Page_Structure_About extends React.Component {
    render () {
        return (
...
export default Ecuador_Indigenous_Page_Structure_About;