...
class Ecuador_Indigeous_Dates extends React.Component {
    render() {
        return (
            <div id="programEcuador">
                <h1 className="colorChange">Indigenous Healing & Public Health in Ecuador — Dates</h1>
                <br/>
...
export default Ecuador_Indigeous_Dates;