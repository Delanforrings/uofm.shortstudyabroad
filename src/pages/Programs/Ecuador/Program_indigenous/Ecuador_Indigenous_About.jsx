...
class Ecuador_Indigenous_About extends React.Component {
    render() {
        return (
            <div id="programEcuador">
                <h1 className="colorChange">Indigenous Healing & Public Health in Ecuador — About</h1>
                <p>
...
export default Ecuador_Indigenous_About;