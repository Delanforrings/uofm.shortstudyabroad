...
import Ecuador_biodiversity_About from "./Ecuador_biodiversity_About";

class Ecuador_biodiversity_Page_Structure_About extends React.Component {
    render () {
        return (
            <div id="Ecuador_Structure">
                <Helmet>
                    <title>About || Study Abroad in Quito, Ecuador || Learning Abroad Center</title>
                </Helmet>
...
export default Ecuador_biodiversity_Page_Structure_About;