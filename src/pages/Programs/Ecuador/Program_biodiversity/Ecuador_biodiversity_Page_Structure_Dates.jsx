...
import Ecuador_biodiversity_Dates from "./Ecuador_biodiversity_Dates";

class Ecuador_biodiversity_Page_Structure_Dates extends React.Component {
    render () {
        return (
            <div id="Ecuador_Structure">
                <Helmet>
                    <title>Dates || Study Abroad in Quito, Ecuador || Learning Abroad Center</title>
                </Helmet>
...
export default Ecuador_biodiversity_Page_Structure_Dates;