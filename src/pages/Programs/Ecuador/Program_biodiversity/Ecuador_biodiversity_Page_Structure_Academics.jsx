...
import Ecuador_biodiversity_Academics from "./Ecuador_biodiversity_Academics";

class Ecuador_biodiversity_Page_Structure_Academics extends React.Component {
    render () {
        return (
            <div id="Ecuador_Structure">
                <Helmet>
                    <title>Academics|| Study Abroad in Quito, Ecuador || Learning Abroad Center</title>
                </Helmet>
                            ...
                            <div className="homeText">
                                <MDBRow around>
                                    ...
                                    <MDBCol size="6">
                                        <div className="homeText">
                                            <Animation type="fadeIn">
                                                <Ecuador_biodiversity_Academics/>
...
export default Ecuador_biodiversity_Page_Structure_Academics;
