...
import Ecuador_biodiversity_Snapshot from "./Ecuador_biodiversity_Snapshot";

class Ecuador_biodiversity_Page_Structure_Snapshot extends React.Component {
    render () {
        return (
            <div id="Ecuador_Structure">
                <Helmet>
                    <title>Snapshot || Study Abroad in Quito, Ecuador || Learning Abroad Center</title>
                </Helmet>
...
export default Ecuador_biodiversity_Page_Structure_Snapshot;