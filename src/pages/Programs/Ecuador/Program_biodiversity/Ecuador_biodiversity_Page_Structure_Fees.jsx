...
import Ecuador_biodiversity_Fees from "./Ecuador_biodiversity_Fees";

class Ecuador_biodiversity_Page_Structure_Fees extends React.Component {
    render () {
        return (
            <div id="Ecuador_Structure">

                <Helmet>
                    <title>Fees || Study Abroad in Quito, Ecuador || Learning Abroad Center</title>
                </Helmet>
...
export default Ecuador_biodiversity_Page_Structure_Fees;