...
import Ecuador_biodiversity_Contact from "./Ecuador_biodiversity_Contact";

class Ecuador_biodiversity_Page_Structure_Contact extends React.Component {
    render () {
        return (
...
export default Ecuador_biodiversity_Page_Structure_Contact;