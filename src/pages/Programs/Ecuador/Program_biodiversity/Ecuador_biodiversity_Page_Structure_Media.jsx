...
import Ecuador_biodiversity_Media from "./Ecuador_biodiversity_Media";


class Ecuador_biodiversity_Page_Structure_Media extends React.Component {
    render () {
        return (
...
export default Ecuador_biodiversity_Page_Structure_Media;